...
/* harmony import */ var _helper_number__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../helper/number */ "./resources/js/src/app/helper/number.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created() {
    this.compInterval = (0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.defaultValue)(this.compInterval, 1);
    this.compInterval = this.compInterval === 0 ? 1 : this.compInterval;
    const minDecimals = (0,_helper_number__WEBPACK_IMPORTED_MODULE_9__.floatLength)(this.min);
    const intervalDecimals = (0,_helper_number__WEBPACK_IMPORTED_MODULE_9__.floatLength)(this.compInterval);
    this.compDecimals = Math.max(minDecimals, intervalDecimals);
    this.onValueChanged = (0,_helper_debounce__WEBPACK_IMPORTED_MODULE_11__.debounce)(() => {
      this.$emit("quantity-change", this.compValue);
    }, (0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.defaultValue)(this.timeout, 500));
    if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isNullOrUndefined)(this.variationId)) {
  ...
  computed: _objectSpread({
    ...
    isMinimum() {
      return (0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isDefined)(this.compMin) && this.compValue - this.compInterval < this.compMin;
    },
    isMaximum() {
      return (0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isDefined)(this.compMax) && this.compValue + this.compInterval > this.compMax;
    },
    minimumHint() {
  ...
  watch: {
    variationId(newValue) {
      if ((0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isDefined)(newValue)) {
        this.fetchQuantityFromBasket();
      }
    },
    basketItems: {
      handler(newValue, oldValue) {
        if ((0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isDefined)(this.variationId)) {
          this.fetchQuantityFromBasket();
        }
      },
      deep: true
    ...
    interval(newInterval) {
      this.compInterval = (0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.defaultValue)(newInterval, 1);
    }
  },
  methods: {
    increaseValue() {
      const newValue = (0,_helper_number__WEBPACK_IMPORTED_MODULE_9__.formatFloat)(this.compValue + this.compInterval, this.compDecimals);
      if (((0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isNullOrUndefined)(this.compMax) || newValue <= this.compMax) && !this.waiting) {
        this.setValue(newValue);
      }
    },
    decreaseValue() {
      const newValue = (0,_helper_number__WEBPACK_IMPORTED_MODULE_9__.formatFloat)(this.compValue - this.compInterval, this.compDecimals);
      if (((0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isNullOrUndefined)(this.compMin) || newValue >= this.compMin) && !this.waiting) {
        this.setValue(newValue);
      }
    },
    setValue(value) {
      ...
      if (isNaN(value)) {
        value = (0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.defaultValue)(this.compMin, 1);
      }

      // limit new value to min/ max value
      value = (0,_helper_number__WEBPACK_IMPORTED_MODULE_9__.limit)(value, this.compMin, this.compMax);

      // make sure, new value is an even multiple of interval
      let diff;
      if (this.variationBasketQuantity === 0 && this.min !== 0) {
        diff = (0,_helper_number__WEBPACK_IMPORTED_MODULE_9__.formatFloat)((value - this.min) % this.compInterval, this.compDecimals, true);
      } else {
        diff = (0,_helper_number__WEBPACK_IMPORTED_MODULE_9__.formatFloat)(value % this.compInterval, this.compDecimals, true);
      }
      ...
      // cut fraction
      value = (0,_helper_number__WEBPACK_IMPORTED_MODULE_9__.formatFloat)(value, this.compDecimals);
      if (value !== this.compValue) {
        this.compValue = value;
        this.onValueChanged();
      } else if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isNullOrUndefined)(this.$refs.quantityInputField)) {
        this.$refs.quantityInputField.value = this.displayValue;
      }
    },
    fetchQuantityFromBasket() {
      if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isNullOrUndefined)(this.min) && this.variationBasketQuantity >= this.min && this.variationBasketQuantity !== 0) {
      ...
      if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_10__.isNullOrUndefined)(this.max)) {
