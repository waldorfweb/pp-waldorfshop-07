...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread({
    ...
    sendReturnItems() {
      ...
      this.sendOrderReturn().then(response => {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_6__["default"].success(this.$translate("Ceres::Template.returnConfirmationInfo")).closeAfter(3000);
        $(this.$refs.orderReturnConfirmation).modal("hide");
        if (this.$store.getters.isLoggedIn) {
          (0,_services_UrlService__WEBPACK_IMPORTED_MODULE_8__.navigateTo)(App.urls.myAccount);
        } else {
          (0,_services_UrlService__WEBPACK_IMPORTED_MODULE_8__.navigateTo)(App.urls.confirmation);
        }
      }, error => {
  ...
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapMutations)(["updateOrderReturnNote"])), (0,vuex__WEBPACK_IMPORTED_MODULE_7__.mapActions)(["sendOrderReturn"]))
});
