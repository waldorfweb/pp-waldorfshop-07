...
/* harmony import */ var _WishListInactiveItem_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./WishListInactiveItem.vue */ "./resources/js/src/app/components/wishList/WishListInactiveItem.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    WishListInactiveItem: _WishListInactiveItem_vue__WEBPACK_IMPORTED_MODULE_7__["default"]
  },
  props: {
    itemDetailsData: {
      type: Array,
  ...
  methods: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_5__.mapActions)(["initWishListItems"]))
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread({
    removeInactiveItem() {
      ...
      }).then(() => _services_NotificationService__WEBPACK_IMPORTED_MODULE_5__["default"].success(this.$translate("Ceres::Template.wishListRemoved")).closeAfter(3000));
    }
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_6__.mapActions)(["removeInactiveWishListItem"]))
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({
    ...
    unitPrice() {
      if (!(0,_helper_utils__WEBPACK_IMPORTED_MODULE_9__.isNullOrUndefined)(this.wishListItem.prices.specialOffer)) {
  ...
  methods: _objectSpread({
    ...
    removeItem() {
      ...
      this.removeWishListItem(item).then(() => _services_NotificationService__WEBPACK_IMPORTED_MODULE_7__["default"].success(this.$translate("Ceres::Template.wishListRemoved")).closeAfter(3000));
    }
  }, (0,vuex__WEBPACK_IMPORTED_MODULE_8__.mapActions)(["removeWishListItem"]))
});
