...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted() {
    if (App.config.basket.addItemToBasketConfirm === "preview") {
      _services_ApiService__WEBPACK_IMPORTED_MODULE_5__["default"].listen("AfterBasketItemAdd", data => {
        this.show();
      });
      _services_ApiService__WEBPACK_IMPORTED_MODULE_5__["default"].listen("AfterBasketItemUpdate", data => {
