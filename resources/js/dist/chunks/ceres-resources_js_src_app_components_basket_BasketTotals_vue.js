...
/* harmony import */ var _helper_OrderPropertyHelper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../helper/OrderPropertyHelper */ "./resources/js/src/app/helper/OrderPropertyHelper.js");
    ...
    setPropertiesForTotals(newBasketItems) {
      ...
      for (const basketItem of newBasketItems) {
        ...
        (_basketItem$variation = basketItem.variation.data.properties) === null || _basketItem$variation === void 0 || _basketItem$variation.forEach(property => {
          if (this.isInBasketItemOrderParams(basketItem, property) && ((0,_helper_OrderPropertyHelper__WEBPACK_IMPORTED_MODULE_9__.isAdditionalCosts)(property) || !(0,_helper_OrderPropertyHelper__WEBPACK_IMPORTED_MODULE_9__.hasVat)(property) && App.useVariationOrderProperties)) {
            ...
            if (existingProperty) {
              ...
              !(0,_helper_OrderPropertyHelper__WEBPACK_IMPORTED_MODULE_9__.hasVat)(property) ? this.displayedPropertiesWithoutTax.push(newProperty) : this.displayedProperties.push(newProperty);
            }
          }
        });
      }
