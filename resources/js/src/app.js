...
import AdvancedDesktopNavigation from "./app/components/pageDesign/AdvancedDesktopNavigation.vue";
...
export function beforeCreate(context)
{
    ...
    Vue.component("advanced-desktop-navigation", AdvancedDesktopNavigation);
